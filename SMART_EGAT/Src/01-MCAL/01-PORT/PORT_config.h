...
/* PortA */
#define PORTA_PIN0_MODE                    PORT_INPUT_ANALOG_MODE
#define PORTA_PIN1_MODE                    PORT_INPUT_ANALOG_MODE
#define PORTA_PIN2_MODE                    PORT_INPUT_ANALOG_MODE
#define PORTA_PIN3_MODE                    PORT_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL_MAX_SPEED_50MHZ
...
#define PORTA_PIN7_MODE                    PORT_INPUT_PULLING_MODE
#define PORTA_PIN8_MODE                    PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTA_PIN9_MODE                    PORT_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTA_PIN10_MODE                   PORT_DEFAULT_MODE
#define PORTA_PIN11_MODE                   PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTA_PIN12_MODE                   PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTA_PIN13_MODE                   PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTA_PIN14_MODE                   PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTA_PIN15_MODE                   PORT_INPUT_PULLING_MODE

/* PortB */
#define PORTB_PIN0_MODE                    PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTB_PIN1_MODE                    PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTB_PIN2_MODE                    PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTB_PIN3_MODE                    PORT_INPUT_PULLING_MODE
#define PORTB_PIN4_MODE                    PORT_INPUT_PULLING_MODE
#define PORTB_PIN5_MODE                    PORT_INPUT_PULLING_MODE
#define PORTB_PIN6_MODE                    PORT_DEFAULT_MODE
#define PORTB_PIN7_MODE                    PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTB_PIN8_MODE                    PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_50MHZ
#define PORTB_PIN9_MODE                    PORT_DEFAULT_MODE
#define PORTB_PIN10_MODE                   PORT_INPUT_PULLING_MODE
#define PORTB_PIN11_MODE                   PORT_DEFAULT_MODE
#define PORTB_PIN12_MODE                   PORT_OUTPUT_ALTERNATE_FUNCTION_PUSH_PULL_MAX_SPEED_50MHZ
...
/* PortC */
#define PORTC_PIN13_MODE                   PORT_OUTPUT_GENERAL_PURPOSE_PUSH_PULL_MAX_SPEED_50MHZ
...
/* PortC */
#define PORTC_PIN13_INITIAL_VALUE          PORT_PIN_HIGH
